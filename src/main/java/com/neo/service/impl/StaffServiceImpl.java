...
public class StaffServiceImpl implements StaffService {
    ...
    public StaffDto updateStaff(StaffDto staffDto, Long staffId) {
        ...
        staff.setStaffAadhaar(staffDto.getStaffAadhaar());
    ...
    public StaffDto getStaffByLogin(LoginDto loginDto) {
        logger.info("Initiating dao call for the get staff Details for Login");
        Staff staff = this.staffRepository.findByLogin(loginDto);
        logger.info("Completed dao call for the get staff Details for Login");
